        ...
        if search_index_manager is not None:
            ...
            if context:
                prompt_messages = PromptTemplate.from_string(
                    'You are a helpful assistant that answers some questions about netflix titles.  '
                    'Be nice in general, but only answer questions with an answer from the context data. If you do not know how to answer, or the question is in a different topic, be nice, apologize and say that you can not help with that topic, and try to help with finding movie and tv shows on netflix instead.\n\nHere is '
